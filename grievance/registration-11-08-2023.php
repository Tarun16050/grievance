    ...
    <nav class="navbar navbar-inverse , navbar" >
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          ...
          <li ><a href="traking.php">Check Status</a></li>        
        </ul>
      ...
      <form action="registration.php" method="post" enctype="multipart/form-data">
            ...
            <p id="errors_last_name" class="field_erros"></p>
                    ...
                    <div class="input-box">
                      ...
                      <div class="input-box">
                        ...
                        <select class="select" id="Category" name='user_type' >
                          <option value="Select Option">Select Option</option>
        ...
        <div class="user-details">
                ...
                <div class="input-box">
                  ...
                  <textarea  class="textarea" rows="4" cols="50" placeholder="Enter Full Address"   name="Address" id="address"></textarea>                  
...
if(isset($_POST['submit']))
{
  ...
  $extention=array('png','jpg','jpeg','pdf','jfif');
            ...
            //   // $jagah=$filename;
            //   $jagah='Silverproject/images/'.$filename;
...
//*************************************** */
            // if(strlen($mobile)!=10){
            //   echo"Please Enter Correct Mobile Number <br><br>";
            // }
...
<script type="text/javascript">
  function validateInput() {
    const inputElement0 = ["first_name", "last_name", "dob","upload_img","gender","Category","District","Block","Village","Postal","Address","Email","Phone","Password","Confirm_Password"];
    const errorElement0 = ["errors_first_name", "errors_last_name", "errors_dob","errors_upload_img","errors_gender","errors_Category","errors_District","errors_Block","errors_Village","errors_Postal","errors_Address","errors_Email","errors_Phone","errors_Password","errors_Confirm_Password"]; 
    const fiels_name =["First Name","Last Name","Date Of Birth","Upload Image","Gender","Select user Category","District","Block/Zone","Village / Ward","Postal Code","Address","Email","Phone Number","Password","Confirm Password"]; 
