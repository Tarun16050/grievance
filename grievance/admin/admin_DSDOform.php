...
if(isset($_POST['submit']))
{
  ...
  $opt='Select Option'; 
  if(empty($error)){    
    $ins="INSERT INTO `users`(`first_name`, `last_name`, `DOB`, `gender`, `Address`, `mobile`, `email`, `password`,`role_type`) VALUES ('$fname','$lname','$DOB','$gender','$Address','$mobile','$email','$psw','DSDO')";
    ...
    {?>
      ...
      window.location.href = "adminDsdo.php";
</script><?php
...
<div class="title">DSDO Registration</div>
      <div class="information">Basic Information</div><hr/>
        <div class="content">
        <form action="admin_DSDOform.php" method="post" enctype="multipart/form-data" id="admin_form">
