        ...
        <form action="" method="post" enctype="multipart/form-data" id="admin_form">
            <div class="user-details">
              <div class="input-box">
                ...
                <input type="text" placeholder="Enter your First name"  name="fname" id="first_name" value="<?= $arrdata['first_name']; ?>">
                <p id="errors_first_name" class="field_erros"></p>
              </div>
              <div class="input-box">
                <span class="details">Last Name<span class="star">*</span></span>
                <input type="text" placeholder="Enter your Last Name"  name="lname"id="last_name" value="<?= $arrdata['last_name'] ; ?>">
...
{   $error = [];
    ...
    $opt='Select Option'; 
    if(empty($error)){    
        $ins="UPDATE `users` SET `id`='$ids',`first_name`='$fname',`last_name`='$lname',`DOB`='$DOB',`gender`='$gender',`Address`='$Address',`mobile`='$mobile',`email`='$email',`password`='$psw' WHERE `id`={$ids}";
