...
if(isset($_POST['submit']))
{
  ...
  $opt='Select Option'; 
  if(empty($error)){    
    $ins="INSERT INTO `users`(`first_name`, `last_name`, `DOB`, `gender`, `Address`, `mobile`, `email`, `password`,`role_type`) VALUES ('$fname','$lname','$DOB','$gender','$Address','$mobile','$email','$psw','Admin')";
